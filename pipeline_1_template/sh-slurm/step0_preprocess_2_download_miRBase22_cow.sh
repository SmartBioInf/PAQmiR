...
$PAQmiR_bin/extract_seq_which_id_contains.pl --fasta_in mature.fa --word bta --file_out ./mature_bta.fa --begining yes
...
$PAQmiR_bin/extract_seq_which_id_contains.pl --fasta_in mature.fa --word bta --file_out ./mature_no_bta.fa --begining yes --inverse yes
...
$PAQmiR_bin/extract_seq_which_id_contains.pl --fasta_in hairpin.fa --word bta --file_out ./hairpin_bta.fa --begining yes
