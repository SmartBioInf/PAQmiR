#création du répertoire miRBase 21
#mkdir ../mirbase21
...
echo "nbre de séquences matures bta dans le fichier miRbase 21 mature.fa" 
...
echo "nbre de séquences matures totales dans le fichier miRbase 21 mature.fa"
grep -c ">" mature.fa

echo "nbre de séquences matures non bta dans le fichier miRbase 21 mature_no_bta.fa"
...
echo "nbre de séquences hairpin bta dans le fichier miRbase 21 hairpin_bta.fa"
grep -c ">" hairpin_bta.fa

#Retirer les espaces de ID des séquences miRbase 21 (pour miRDeep2)
